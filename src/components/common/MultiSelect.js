...
import { View, TouchableOpacity, FlatList, UIManager, ScrollView, Animated, Easing, Text } from 'react-native'
			...
			<Animated.View style={{ height: this.state.animation, overflow: 'hidden' }}>
				<View onLayout={this._setMinHeight.bind(this)}>
					<TouchableOpacity onPress={this._submitSelection}
						...
						<FontAwesome style={{ color: '#4c4c4c', fontSize: 28, lineHeight: 40, alignSelf: 'flex-end' }} name="angle-down" />
					</TouchableOpacity>
				</View>
